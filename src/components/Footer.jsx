...
import { FaFacebookF, FaInstagram, FaTwitter, FaLinkedin, FaYoutube, FaPhoneAlt, FaMapMarkerAlt, FaEnvelope } from 'react-icons/fa';
      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <form className="flex">
              <input type="email" placeholder="Enter your email" className="p-2 w-full rounded-l-md border-none" />
              <button type="submit" className="p-2 bg-white text-blue-700 rounded-r-md ">Subscribe</button>
            </form>
            <div className="flex space-x-9 pt-7">
